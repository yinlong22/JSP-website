<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XWZWList.aspx.cs" Inherits="JW_XWZWList" %>
   ...
   <div align="center">
                            ...
                            <tr>
                                <td >
                                    <table  
                                        ...
                                        <tr>
                                           <td height="25" width="30%" align="center" class="tdHeader"> [校外实习职位管理]</td>
		...
		<asp:ImageButton ID="btnAdd0" runat="server" 
            ImageUrl="~/images/button_search.GIF" onclick="BtnSearch_Click" />
				...
				<asp:BoundField DataField="实习职位" HeaderText="实习职位" >
		</asp:BoundField>
