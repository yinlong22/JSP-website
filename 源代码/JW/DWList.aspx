<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DWList.aspx.cs" Inherits="JW_DWList" %>
   ...
   <div align="center">
                            ...
                            <tr>
                                <td >
                                    <table  
                                        ...
                                        <tr>
                                           <td height="25" width="30%" align="center" class="tdHeader"> [<asp:Label 
		...
		<asp:ImageButton ID="btnAdd" runat="server" 
            ImageUrl="~/images/button_add.gif" onclick="btnAdd_Click" />
                                        ...
                                        <tr>
                                           <td height="25" width="30%" align="right" class="tdHeader"> 
		                                       单位名称：<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
		<asp:ImageButton ID="btnAdd0" runat="server" 
            ImageUrl="~/images/button_search.GIF" onclick="BtnSearch_Click" />
				...
				<asp:BoundField DataField="单位介绍" HeaderText="单位介绍" >
		</asp:BoundField>
