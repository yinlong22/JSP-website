...
public partial class JW_XWZW : PageBase
{
		...
		protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            DropDownList1.DataSource = DataControl.GetData("select * from 单位 where 单位类别='XW'");
    ...
    protected void btnAdd_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Page.ClientScript.RegisterStartupScript(this.GetType(), "info", "<script>alert('保存成功！');window.location.href='XWZWList.aspx';</script>");
    ...
    {
        Response.Redirect("XWZWList.aspx");
    }
