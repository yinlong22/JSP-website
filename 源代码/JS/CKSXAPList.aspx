...
<body>
   ...
   <div align="center">
            <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" id="Table2">
                <tr>
                    <td   valign="top">
                            ...
                            <tr>
                                <td >
                                    <table  
                                        ...
                                        <tr>
                                           <td height="25" width="30%" align="center" class="tdHeader"> [企业评价学生管理]</td>
            ...
            ImageUrl="~/images/button_search.GIF" onclick="BtnSearch_Click" />
                            ...
                            <td>
                            	<asp:GridView ID="gvData" runat="server" AllowPaging="True" 
                                    ...
                                    <Columns><asp:BoundField DataField="职位" HeaderText="职位" >
		</asp:BoundField>
                                        ...
                                        <asp:TemplateField HeaderText="操作">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="btn_Modify" runat="server" BackColor="Transparent" 
                                                    BorderStyle="None" CommandName="Mod" ForeColor="#3a6ea5" Text="评价学生"></asp:LinkButton>
                                            </ItemTemplate>
