<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SXZJList.aspx.cs" Inherits="XS_SXZJList" %>
                            ...
                            <tr>
                                <td >
                                    <table  
                                        ...
                                        <tr>
                                           <td height="25" width="30%" align="center" class="tdHeader"> [学生实习周记]</td>
	                                   
                                        </tr>
                                       
                                        <tr>
                                           <td height="25" width="30%" align="right" class="tdHeader"> 
		                                       职位：<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
            ...
            ImageUrl="~/images/button_search.GIF" onclick="BtnSearch_Click" />
                            ...
                            <td>
                            	<asp:GridView ID="gvData" runat="server" AllowPaging="True" 
                                    ...
                                    <Columns><asp:BoundField DataField="周记日期" HeaderText="周记日期" >
		</asp:BoundField>
				<asp:BoundField DataField="周次" HeaderText="周次" >
		</asp:BoundField>
				<asp:BoundField DataField="周记主题" HeaderText="周记主题" >
		</asp:BoundField>
