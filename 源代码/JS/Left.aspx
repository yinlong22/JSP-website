	...
	<body  >
		<form id="Form1"  runat="server">
	        ...
	        <li><a class="qmparent" href="#">系统管理</a>
		        ...
		        <ul>
		        <li><a href="SXZJList.aspx" target="OfficeMain" >查看实习周记</a></li>		
		        <li><a href="CKSXAPList.aspx" target="OfficeMain" >评价学生管理</a></li>
		        <li><a href="../Say/YgltList.aspx" target="OfficeMain" >教师答疑管理</a></li> 
