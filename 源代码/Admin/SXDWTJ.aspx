<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SXDWTJ.aspx.cs" Inherits="Admin_SXDWTJ" %>
                            ...
                            <tr>
                                <td >
                                    <table  
                                        ...
                                        <tr>
                                           <td height="25" width="30%" align="center" class="tdHeader"> [单位实习生情况统计]</td>
                            ...
                            <td>
                            	<asp:GridView ID="gvData" runat="server" AllowPaging="True" 
                                    ...
                                    <Columns>
				                                ...
				                                <asp:BoundField DataField="单位性质" HeaderText="单位性质" />
                                                <asp:BoundField DataField="单位规模" HeaderText="单位规模" />
                                                <asp:BoundField DataField="所属行业" HeaderText="所属行业" />
				<asp:BoundField DataField="实习生人数" HeaderText="实习生人数" >
		</asp:BoundField>
		                                        
                                        <asp:TemplateField HeaderText="操作">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="btn_Modify" runat="server" BackColor="Transparent" 
                                                    BorderStyle="None" CommandName="Mod" ForeColor="#3a6ea5" Text="查看"></asp:LinkButton>
                                            </ItemTemplate>
