<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SXSSee.aspx.cs" Inherits="Admin_SXSSee" %>
...
<body>
   ...
   <div align="center">
            <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" id="Table1">
                            ...
                            <tr>
                                <td >
                                    <table  
                                        ...
                                        <tr>
                                           <td height="25" width="30%" align="center" class="tdHeader"> [实习生所属情况介绍]</td>
				...
				<asp:BoundField DataField="个人技能" HeaderText="个人技能" >
		</asp:BoundField>
