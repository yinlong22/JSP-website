...
public partial class Admin_GZZTTJ : System.Web.UI.Page
{
    ...
    private void BindResult()
    {
        ...
        //组合查询条件 
        DataTable dt = DataControl.GetData("select 完成情况,count(1) as 实习生人数 from V_安排  group by 完成情况  ");
        if (dt != null)
        {
            this.gvData.DataKeyNames = new string[] { "完成情况" };
    ...
    protected void gvData_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            string strUrl = "SXSSee.aspx?WCQK=" + gvData.DataKeys[num]["完成情况"].ToString();
