...
public partial class Admin_SXSList : System.Web.UI.Page
{
    ...
    private void BindResult()
    {
        ...
        //组合查询条件 
        DataTable dt = DataControl.GetData("select * from  实习生 where 学号 like '%"+TextBox1.Text+"%' and 姓名 like '%"+TextBox2.Text+"%'");
        if (dt != null)
        {
    ...
    protected void gvData_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            string strUrl = "SXS.aspx?ID=" + gvData.DataKeys[num]["学号"].ToString();
            PageBase.OpenWebForm(strUrl);
        }
        else if (e.CommandName == "Del")
        {
            DataControl.Execute("delete from 实习生 where 学号='" + gvData.DataKeys[num]["学号"].ToString() + "'");
            BindResult();
        }
    }
