<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FBTJ.aspx.cs" Inherits="Admin_FBTJ" %>
                        ...
                        <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
                            <tr>
                                <td >
                                    <table  
                                        ...
                                        <tr>
                                           <td height="25" width="30%" align="center" class="tdHeader"> [校内外分布情况统计]</td>
                            ...
                            <td>
                            	<asp:GridView ID="gvData" runat="server" AllowPaging="True" 
                                    ...
                                    <Columns>
                                        		<asp:BoundField DataField="分布情况" HeaderText="分布情况" >
		</asp:BoundField>
