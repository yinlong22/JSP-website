	...
	<body  >
		<form id="Form1"  runat="server">
	        ...
	        <li><a class="qmparent" href="#">系统管理</a>
		        ...
		        <ul>
		            <li><a href="RYList.aspx" target="OfficeMain" >人员信息管理</a></li>
		              <li><a href="SXSList.aspx" target="OfficeMain" >实习生管理</a></li>
		          	
		        </ul></li>	       
  <li><a class="qmparent" href="#">报表管理</a>

		        <ul>
		            <li><a href="FBTJ.aspx" target="OfficeMain" >实习生分布情况统计</a></li>
		            <li><a href="SXDWTJ.aspx" target="OfficeMain" >实习单位岗位统计</a></li>
		            <li><a href="GZZTTJ.aspx" target="OfficeMain" >实习完成情况统计</a></li>
