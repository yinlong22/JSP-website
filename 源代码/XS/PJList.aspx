<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PJList.aspx.cs" Inherits="XS_PJList" %>
   ...
   <div align="center">
            <table width="99%" border="0" cellspacing="0" cellpadding="0" align="center" id="Table1">
                            ...
                            <tr>
                                <td >
                                    <table  
                                        ...
                                        <tr>
                                           <td height="25" width="30%" align="center" class="tdHeader"> [评价单位信息]</td>
				...
				<asp:BoundField DataField="工作时间" HeaderText="工作时间" >
                                        ...
                                        <asp:TemplateField HeaderText="操作" Visible="true">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="btn_Modify" runat="server" BackColor="Transparent" 
                                                    BorderStyle="None" CommandName="Mod" ForeColor="#3a6ea5" Text="评价单位"></asp:LinkButton>
                                            </ItemTemplate>
