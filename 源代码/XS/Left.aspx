	...
	<body  >
		<form id="Form1"  runat="server">
	        ...
	        <li><a class="qmparent" href="#">系统管理</a>
		        ...
		        <li><a class="qmparent" href="#">我的功能菜单</a> 
		        <ul>
		        <li><a href="CKSXAPList.aspx" target="OfficeMain" >查看实习安排</a></li>		
		        <li><a href="SXZJList.aspx" target="OfficeMain" >实习周记管理</a></li>
		        <li><a href="PJList.aspx" target="OfficeMain" >单位评价管理</a></li> 
		          <li><a href="../Say/YgltList.aspx" target="OfficeMain" >学生实习答疑</a></li> 
